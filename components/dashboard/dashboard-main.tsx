...
import TransactionDatatable, {type Item as TransactionItem } from '@/components/shadcn-studio/blocks/datatable-transaction'
import type { StatisticsCardData, EarningData } from '@/types/dashboard.type'

export function DashboardMain({ statisticsCardData, transactionData, earningsData }: { statisticsCardData: StatisticsCardData[], transactionData: TransactionItem[], earningsData: EarningData[] }) {
  return (
